# LRU Cache
# Tonight we're going to use an array to implement a basic Least Recently Used (LRU) Cache. This will be a simple implementation that doesn't use a hash map or linked list. We will assume our input is limited to Integers, Strings, Arrays, Symbols, and Hashes. We will allow the user to set the size of the cache.
